...
#define BWD       0x1FE00FF // go backward  
#define STOP      0x1FEB04F // stop
#define RPEAT     0x1FE50AF // repeat the stored sequence of movement from the temporary memory(automatically stores)
#define DEL       0x1FEF807 // delete the stored sequence of movement from temporary memory(EQ)
#define RESET     0x1FEE01F // Resets the Arduino Board(RED)
